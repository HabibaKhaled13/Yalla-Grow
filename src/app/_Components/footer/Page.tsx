...
<h2 className='text-xl font-semibold uppercase'>Explore</h2>
      <ul className='text-stone-300 '><li className='mt-4 mb-2'>About us</li>
      <li className='mb-2'>Work</li>
      <li className='mb-2'>Portdolio</li>
      <li >Contact us</li>
      </ul>
    </div>
      <div className="letsTalk uppercase md:w-[27%] w-full text-center md:text-left  self-center">   <h2 className={`${style['animated-text']} text-6xl font-bold` }>Let's Talk</h2></div>
      </div>
